...
const (
	keyLeftShift       uint32 = 0xFFE1
	defaultKeyInterval        = 100 * time.Millisecond
	shiftedChars              = "~!@#$%^&*()_+{}|:\"<>?"
)
...
// SendKey handles key events
func (d *vncDriver) SendKey(key rune, action bootcommand.KeyAction) error {
...
// SendSpecial handles key events with special keys
func (d *vncDriver) SendSpecial(special string, action bootcommand.KeyAction) error {
